...
Then we can add *@ConfigurationPropertiesScan* annotation on the main Application class to
...
Note that we have used the *SpEL* expression *$\{app.queue}* to configure the queue name using
